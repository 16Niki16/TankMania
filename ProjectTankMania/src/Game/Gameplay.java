...
public class Gameplay extends JPanel implements Runnable {
    ...
    public Gameplay(Main main) { //sets up all tanks, map, images, new tread and Key actions
    ...
    public Line2D[] tankSides(Tank tank) { //returns the 4 sides of a specified thank 
    	Point[] edges= {
    			new Point((int)(Math.cos(tank.getRotation()+tankRatioAngle)*tankDistance + tank.getX()+ 45), 
    					(int)(Math.sin(tank.getRotation()+tankRatioAngle)*tankDistance + tank.getY()+ 22.5)),
    			
    			new Point((int)(Math.cos(tank.getRotation()-tankRatioAngle)*tankDistance + tank.getX()+ 45), 
    					(int)(Math.sin(tank.getRotation()-tankRatioAngle)*tankDistance + tank.getY()+ 22.5)),
    			
    			new Point((int)(Math.cos(tank.getRotation()+tankRatioAngle+Math.PI)*tankDistance + tank.getX()+ 45), 
    					(int)(Math.sin(tank.getRotation()+tankRatioAngle+Math.PI)*tankDistance + tank.getY()+22.5)),
    ...
    private class shot extends moveTank {
        ...
        public void actionPerformed(ActionEvent e) {
            if (tank.shoot()) {
                shotList.add(new Shot(Math.cos(tank.getRotation())*66 + tank.getX()+ 45, Math.sin(tank.getRotation())*66 + tank.getY() + 22.5, 20, tank.getRotation()));
            }
        }
    }
